...
function toggleCruiseSpeed ()
	...
	setElementData(theVehicle, "cruiseSpeedEnabled", cruiseSpeedEnabled)
end
addEvent ("toggleCruiseSpeed", true)
addEventHandler ("toggleCruiseSpeed", getRootElement (), toggleCruiseSpeed)
